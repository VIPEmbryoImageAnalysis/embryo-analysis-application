...
def removeTemporaryDirs(org_folders, org2_folders, org3_folders):
...
def openNewWindow():
    try:
        ...
        yesRemoveButton3 = tk.Button(frame5, text = 'Load new videos', command = lambda: [newWindow.destroy(), RemoveAllVideos(), removeTemporaryDirs(org_folders, org2_folders, org3_folders)])
        yesRemoveButton3.place(relx=0.075, rely=0.6, relwidth=0.40, relheight=0.30)
        yesRemoveButton4 = tk.Button(frame5, text = 'Close App', command = lambda: [newWindow.destroy(), root.destroy(), removeTemporaryDirs(org_folders, org2_folders, org3_folders)])
